...
TARGET = VI4310_Qtech_NewCalibration_1.0
...
win32: LIBS += -L$$PWD/DTCCM2_SDK/ -ldtccm2

INCLUDEPATH += $$PWD/DTCCM2_SDK
DEPENDPATH += $$PWD/DTCCM2_SDK

win32: LIBS += -L$$PWD/DTCCM2_SDK/ -lDtccmKit
